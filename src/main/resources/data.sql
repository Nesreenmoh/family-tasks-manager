...
-- Insert parents
INSERT INTO parent (fname, lname, email) VALUES ('John', 'Doe', 'john.doe@example.com');
INSERT INTO parent (fname, lname, email) VALUES ('Jane', 'Smith', 'jane.smith@example.com');

-- Insert children
INSERT INTO child (fname, lname, age, parent_id) VALUES ('Alice', 'Doe', 10, 1);
INSERT INTO child (fname, lname, age, parent_id) VALUES ('Bob', 'Doe', 8, 1);
INSERT INTO child (fname, lname, age, parent_id) VALUES ('Charlie', 'Smith', 12, 2);
